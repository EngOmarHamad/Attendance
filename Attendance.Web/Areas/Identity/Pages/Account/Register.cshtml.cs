...
namespace Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(UserManager<UserModel> userManager, IUserStore<UserModel> userStore, SignInManager<UserModel> signInManager, ILogger<RegisterModel> logger, IEmailSender emailSender)
        {
